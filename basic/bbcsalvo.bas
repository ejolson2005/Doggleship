...
1480   NEXT Z
1490 NEXT K
1500 PRINT "DO YOU WANT TO START";
1510 INPUT J$
1520 IF J$<>"WHERE ARE YOUR SHIPS?" THEN 1680
1530 PRINT "BATTLESHIP"
1540 FOR Z=1 TO 5
1550   PRINT " ";F(Z);"  ";G(Z)
1560 NEXT Z
1570 PRINT "CRUISER"
...
1620 PRINT " ";F(9);"  ";G(9)
1630 PRINT " ";F(10);"  ";G(10)
1640 PRINT "DESTROYER<B>"
1650 PRINT " ";F(11);"  ";G(11)
1660 PRINT " ";F(12);"  ";G(12)
1670 GOTO 1500
1680 PRINT "ENTER COORDINATES FOR..."
1690 PRINT "BATTLESHIP"
1700 FOR X=1 TO 5
1710   INPUT Y,Z
1720   B(Y,Z)=3
1730 NEXT X
...
1770   B(Y,Z)=2
1780 NEXT X
1790 PRINT "DESTROYER<A>"
1800 FOR X=1 TO 2
1810   INPUT Y,Z
1820   B(Y,Z)=1
1830 NEXT X
1840 PRINT "DESTROYER<B>"
1850 FOR X=1 TO 2
1860   INPUT Y,Z
1870   B(Y,Z)=.5
1880 NEXT X
